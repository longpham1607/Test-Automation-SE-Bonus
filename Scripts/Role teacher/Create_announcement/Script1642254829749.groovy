...
WebUI.click(findTestObject('Object Repository/Page_moodle1 Log in to the site/form_document.getElementById(anchor).value _70e5d4'))
...
WebUI.click(findTestObject('Object Repository/Page_Course Mon hoc/span_Announcements Forum'))

WebUI.click(findTestObject('Object Repository/Page_Announcements/a_Add a new topic'))

WebUI.setText(findTestObject('Object Repository/Page_Announcements/input_Subject_subject'), 'Test Annoucement')

WebUI.setText(findTestObject('Object Repository/Page_Announcements/div_Test announcement'), 'Test announcement')
