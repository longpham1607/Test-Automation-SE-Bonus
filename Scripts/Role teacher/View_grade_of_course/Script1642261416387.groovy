...
WebUI.click(findTestObject('Object Repository/Page_moodle1 Log in to the site/div_document.getElementById(anchor).value  _bffe56'))
...
WebUI.click(findTestObject('Object Repository/Page_Course Mon hoc/span_Grades'))
