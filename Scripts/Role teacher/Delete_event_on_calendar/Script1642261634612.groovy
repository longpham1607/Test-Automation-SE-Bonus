...
WebUI.click(findTestObject('Object Repository/Page_moodle Calendar Detailed month view Ja_b2996f/a_Test add event on calendar'))

WebUI.click(findTestObject('Object Repository/Page_moodle Calendar Detailed month view Ja_b2996f/button_Delete'))

WebUI.click(findTestObject('Object Repository/Page_moodle Calendar Detailed month view Ja_b2996f/button_Delete event'))
