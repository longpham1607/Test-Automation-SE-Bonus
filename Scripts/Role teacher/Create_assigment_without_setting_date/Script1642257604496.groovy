...
WebUI.click(findTestObject('Object Repository/Page_Course Mon hoc/div_Assignment'))

WebUI.setText(findTestObject('Object Repository/Page_Editing Assignment/input_Assignment name_name'), 'Katalon assignment')

WebUI.setText(findTestObject('Object Repository/Page_Editing Assignment/div_Katalon assigment'), 'Katalon assigment')
