...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/div_Course category                        _d77845'))
...
WebUI.click(findTestObject('Object Repository/Page_Course Mon hoc/div_Information about the Folder activity_o_1fd216'))

WebUI.setText(findTestObject('Object Repository/Page_Editing Forum/input_Forum name_name'), 'Test add discussion forum')
