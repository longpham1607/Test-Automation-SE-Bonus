...
WebUI.click(findTestObject('Object Repository/Page_moodle Calendar Detailed month view Ja_b2996f/span_assignment_with_date is due'))

WebUI.click(findTestObject('Object Repository/Page_moodle Calendar Detailed month view Ja_b2996f/a_Go to activity'))
