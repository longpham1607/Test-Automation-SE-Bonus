...
WebUI.click(findTestObject('Object Repository/Page_CS123 quiz_test/button_Re-attempt quiz'))

WebUI.click(findTestObject('Object Repository/Page_CS123 quiz_test/input_Time limit_submitbutton'))

WebUI.setText(findTestObject('Object Repository/Page_quiz_test/input_Answer_q31_answer'), '10')
...
WebUI.click(findTestObject('Object Repository/Page_quiz_test Attempt summary/input_Once you submit, you will no longer b_d06e16'))
