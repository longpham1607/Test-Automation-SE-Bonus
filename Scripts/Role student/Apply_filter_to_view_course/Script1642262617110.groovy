...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_Course name'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Last accessed'))
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/button_List'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Summary'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_Summary_1'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Card'))
