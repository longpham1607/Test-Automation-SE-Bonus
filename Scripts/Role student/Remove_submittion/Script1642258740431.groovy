...
WebUI.click(findTestObject('Object Repository/Page_Course Mon hoc/span_create assigment test Assignment'))

WebUI.click(findTestObject('Object Repository/Page_CS123 create assigment test/button_Remove submission'))

WebUI.click(findTestObject('Object Repository/Page_CS123 create assigment test/button_Continue'))
