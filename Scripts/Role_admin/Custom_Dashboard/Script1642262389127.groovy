...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/button_Customise this page'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_Add a block'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/a_Courses'))
