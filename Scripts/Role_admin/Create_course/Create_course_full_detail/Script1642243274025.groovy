...
WebUI.setText(findTestObject('Object Repository/Page_moodle Add a new course/input_Course full name_fullname'), 'Mon hoc')

WebUI.setText(findTestObject('Object Repository/Page_moodle Add a new course/input_Course short name_shortname'), 'CS123')
