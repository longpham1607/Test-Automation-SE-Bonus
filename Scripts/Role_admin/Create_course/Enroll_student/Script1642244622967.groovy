...
WebUI.click(findTestObject('Object Repository/Page_CS123 Participants/small_pghan19apcs.vn'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_CS123 Participants/select_Phung Gia Han    pghan19apcs.vn     _b31fce'), 
    '12', true)
