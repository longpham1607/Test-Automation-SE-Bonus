...
WebUI.click(findTestObject('Object Repository/Page_moodle Administration Search/a_Grades'))

WebUI.click(findTestObject('Object Repository/Page_moodle Administration Search/a_Plugins'))

WebUI.click(findTestObject('Object Repository/Page_moodle Administration Search/a_Appearance'))

WebUI.click(findTestObject('Object Repository/Page_moodle Administration Search/a_Server'))

WebUI.click(findTestObject('Object Repository/Page_moodle Administration Search/a_Reports'))

WebUI.click(findTestObject('Object Repository/Page_moodle Administration Search/a_Development'))
